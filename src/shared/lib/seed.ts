...
// Based on Bank Sampah Mulia price list
// buy_rate = what we pay nasabah (from HTML)
// default_rate = what we charge vendors (buy_rate / 0.90)
const CATEGORIES: CategorySeed[] = [
  { id: 'a3', name: 'a3', unit: 'kg', default_rate: 10000, buy_rate: 9000 },
  { id: 'b8', name: 'b8', unit: 'kg', default_rate: 167, buy_rate: 150 },
  { id: 'b9', name: 'b9', unit: 'pcs', default_rate: 389, buy_rate: 350 },
  { id: 'b10', name: 'b10', unit: 'pcs', default_rate: 500, buy_rate: 450 },
  { id: 'b11', name: 'b11', unit: 'pcs', default_rate: 278, buy_rate: 250 },
  { id: 'c1', name: 'c1', unit: 'kg', default_rate: 5000, buy_rate: 4500 },
  { id: 'c2', name: 'c2', unit: 'kg', default_rate: 7000, buy_rate: 6300 },
  { id: 'k1', name: 'k1', unit: 'kg', default_rate: 1667, buy_rate: 1500 },
  { id: 'k2', name: 'k2', unit: 'kg', default_rate: 167, buy_rate: 150 },
  { id: 'k3', name: 'k3', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'k4', name: 'k4', unit: 'kg', default_rate: 3000, buy_rate: 2700 },
  { id: 'k5', name: 'k5', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'k6', name: 'k6', unit: 'kg', default_rate: 1778, buy_rate: 1600 },
  { id: 'k7', name: 'k7', unit: 'kg', default_rate: 167, buy_rate: 150 },
  { id: 'k8', name: 'k8', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'k9', name: 'k9', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'k10', name: 'k10', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'l1', name: 'l1', unit: 'kg', default_rate: 2667, buy_rate: 2400 },
  { id: 'p5', name: 'p5', unit: 'kg', default_rate: 3778, buy_rate: 3400 },
  { id: 'p6', name: 'p6', unit: 'kg', default_rate: 556, buy_rate: 500 },
  { id: 'p7', name: 'p7', unit: 'kg', default_rate: 2444, buy_rate: 2200 },
  { id: 'p8', name: 'p8', unit: 'kg', default_rate: 2778, buy_rate: 2500 },
  { id: 'p9', name: 'p9', unit: 'kg', default_rate: 1778, buy_rate: 1600 },
  { id: 'p10', name: 'p10', unit: 'kg', default_rate: 4000, buy_rate: 3600 },
  { id: 'p11', name: 'p11', unit: 'kg', default_rate: 4444, buy_rate: 4000 },
  { id: 'p12', name: 'p12', unit: 'kg', default_rate: 4000, buy_rate: 3600 },
  { id: 'p14', name: 'p14', unit: 'kg', default_rate: 1000, buy_rate: 900 },
  { id: 'p17', name: 'p17', unit: 'kg', default_rate: 278, buy_rate: 250 },
  { id: 'p20', name: 'p20', unit: 'kg', default_rate: 778, buy_rate: 700 },
  { id: 'p21', name: 'p21', unit: 'kg', default_rate: 3444, buy_rate: 3100 },
  { id: 'p22', name: 'p22', unit: 'kg', default_rate: 2000, buy_rate: 1800 },
  { id: 'p23', name: 'p23', unit: 'kg', default_rate: 0, buy_rate: 0 },
  { id: 'p25', name: 'p25', unit: 'kg', default_rate: 3000, buy_rate: 2700 },
  { id: 'p26', name: 'p26', unit: 'kg', default_rate: 778, buy_rate: 700 },
  { id: 'p29', name: 'p29', unit: 'kg', default_rate: 3778, buy_rate: 3400 },
  { id: 'p31', name: 'p31', unit: 'pcs', default_rate: 4000, buy_rate: 3600 },
  { id: 'p32', name: 'p32', unit: 'kg', default_rate: 4000, buy_rate: 3600 },
  { id: 'p34', name: 'p34', unit: 'kg', default_rate: 500, buy_rate: 450 },
  { id: 'p35', name: 'p35', unit: 'kg', default_rate: 3000, buy_rate: 2700 },
  { id: 'p37', name: 'p37', unit: 'kg', default_rate: 1444, buy_rate: 1300 },
  { id: 'p38', name: 'p38', unit: 'kg', default_rate: 1444, buy_rate: 1300 },
  { id: 'p39', name: 'p39', unit: 'kg', default_rate: 111, buy_rate: 100 },
  { id: 'p45', name: 'p45', unit: 'kg', default_rate: 1056, buy_rate: 950 },
  { id: 'p46', name: 'p46', unit: 'kg', default_rate: 278, buy_rate: 250 },
  { id: 's1', name: 's1', unit: 'kg', default_rate: 2000, buy_rate: 1800 },
  { id: 's2', name: 's2', unit: 'kg', default_rate: 778, buy_rate: 700 },
  { id: 's3', name: 's3', unit: 'kg', default_rate: 0, buy_rate: 0 },
  { id: 't1', name: 't1', unit: 'kg', default_rate: 40000, buy_rate: 36000 },
]
